...
self.addEventListener('fetch', (e) => {
  ...
  // Navegação (abrir o app): rede primeiro (pega atualizações), cai pro cache se offline.
  ...
  // Demais GETs (CDN, Supabase, bandeiras): deixa a rede cuidar (dados sempre frescos).
});
